...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(),"AIzaSyCT5yDh7KxYXT9Rxw4nZ6DTKBnpH_0V_A4");
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                // TODO: Get info about the selected place. Place.Field.NAME
            ...
            public void onError(Status status) {
                ...
                Toast.makeText(CustomerMapActivity.this, "An error Occured..", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    *-------------------------------------------------------------------*/
    ...
    private void endRide(){
        ...
        mDriverProfileImage.setImageResource(R.drawable.ic_default);
    }
